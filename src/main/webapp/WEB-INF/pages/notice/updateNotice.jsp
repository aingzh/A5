...
<head>
    <meta charset="utf-8">
    <title>Modify the announcement information</title>
...
<div class="layui-form layuimini-form">
    ...
    <div class="layui-form-item">
        <label class="layui-form-label">Announcement subject</label>
    ...
    <div class="layui-form-item layui-form-text">
        <label class="layui-form-label">Announcement content</label>
        <div class="layui-input-block">
