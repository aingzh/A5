    ...
    <div class="layuimini-main">
        ...
        <script type="text/html" id="toolbarDemo">
            <div class="layui-btn-container">
                ...
                <%--<button class="layui-btn layui-btn-normal layui-btn-sm data-add-btn" lay-event="back"> Return Point</button>--%>
            </div>
        </script>
...
<script>
    layui.use(['form', 'table'], function () {
        ...
        table.render({
            elem: '#currentTableId',
            url: '${pageContext.request.contextPath}/lendListAllOfReader2',//查询借阅图书记录
            toolbar: '#toolbarDemo',
            defaultToolbar: ['filter', 'exports', 'print', {
                title: 'Tips',
                layEvent: 'LAYTABLE_TIPS',
