...
<div class="layui-form layuimini-form">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="address" placeholder="Please enter reader's address" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    --%>
    <div class="layui-form-item">
        <label class="layui-form-label required">Resigned or not</label>
        <div class="layui-input-block">
